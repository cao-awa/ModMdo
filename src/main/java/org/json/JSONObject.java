...
import com.github.zhuaidadaya.rikaishinikui.handler.conductor.string.tokenizer.*;
...
public class JSONObject {
    ...
    public JSONObject(Map<?, ?> m) {
        if (m == null) {
            ...
            this.map = new Object2ObjectOpenHashMap<>(m.size());
    ...
    public JSONObject(String baseName, Locale locale) throws JSONException {
        ...
        while (keys.hasMoreElements()) {
            ...
            if (key != null) {
                ...
                StringTokenizerConductor conductor = new StringTokenizerConductor(new StringTokenizer(key, "."));
                int last = conductor.size() - 1;
                int current = 0;
                JSONObject target = this;
                for (String segment : conductor) {
                    if (current == last) {
                        target.put(segment, bundle.getString(key));
                        break;
                    }
     ...
     *
     * @param l
     *         the Left value to compare. Can not be <code>null</code>.
     * @param r
     *         the right value to compare. Can not be <code>null</code>.
