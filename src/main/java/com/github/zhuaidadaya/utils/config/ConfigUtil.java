...
public class ConfigUtil implements AbstractConfigUtil {
    /**
     *
     */
    //    private final Object2ObjectMap<Object, Config<Object, Object>> configs = new Object2ObjectRBTreeMap<>();
    private final Object2ObjectMap<Object, Config<Object, Object>> configs = new Object2ObjectRBTreeMap<>();
    ...
    public ConfigUtil(String entrust, String configPath, String configName, String configVersion, boolean empty, boolean loadManifest) {
        defaultUtilConfigs();
        setPath(configPath);
        setName(configName);
        setVersion(configVersion);
...
test1();
    ...
    public static void test1() {
        ConfigUtil config = new ConfigUtil("CU", "config/", "test.mhf", "1.1") //
        ...
        int count = 0;
        //        config.set("test", "teeeeeeeeeeeeeeeeeeeeeeeeests");
        while(true) {
            try {
                count++;
    ...
    public Config<Object, Object> get(Object conf) {
    ...
    public JSONObject toJSONObject() {
        ...
        for(Config<Object, Object> config : configs.values()) {
            addToConfig.put(config.toJSONObject());
        }
