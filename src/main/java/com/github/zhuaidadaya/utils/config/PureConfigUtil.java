...
public class PureConfigUtil implements AbstractConfigUtil {
    /**
     *
     */
    private final Object2ObjectMap<Object, ReformPureConfig<Object>> configs = new Object2ObjectRBTreeMap<>();
    ...
    public PureConfigUtil() {
        defaultUtilConfigs();
        readConfig(true);
    }

    public PureConfigUtil(String entrust) {
        defaultUtilConfigs();
        logger = LogManager.getLogger("ConfigUtil-" + entrust);
        readConfig(true);
    }

    public PureConfigUtil(String entrust, String configPath) {
        defaultUtilConfigs();
        setPath(configPath);
        logger = LogManager.getLogger("ConfigUtil-" + entrust);
        readConfig(true);
    ...
    public PureConfigUtil(String entrust, String configPath, String configName) {
        defaultUtilConfigs();
        setPath(configPath);
        setName(configName);
        setEntrust(entrust);
    ...
    public PureConfigUtil(String entrust, String configPath, String configName, String configVersion) {
        defaultUtilConfigs();
        setPath(configPath);
        setName(configName);
    ...
    public PureConfigUtil(String entrust, String configPath, String configName, String configVersion, boolean empty) {
        defaultUtilConfigs();
        setPath(configPath);
        setName(configName);
        setVersion(configVersion);
    ...
    public PureConfigUtil(String entrust, String configPath, String configName, String configVersion, boolean empty, boolean loadManifest) {
        defaultUtilConfigs();
        setPath(configPath);
        setName(configName);
        setVersion(configVersion);
    ...
    public static void main(String[] args) {
        PureConfigUtil config = new PureConfigUtil("CU", "config/", "test_pure.mhf", "1.1") //
    ...
    public static PureConfigUtil emptyConfigUtil() {
        return new PureConfigUtil(null, null, "1.1", null, true);
    }

    public PureConfigUtil setPath(String path) {
        addUtilConfig("path", path);
        return this;
    }

    public PureConfigUtil setVersion(String version) {
        addUtilConfig("version", version);
        return this;
    }

    public PureConfigUtil setName(String name) {
        try {
    ...
    public PureConfigUtil setPath(File path) {
    ...
    public void addUtilConfig(Object name, Object value) {
        configs.put("CU%" + name, new ReformPureConfig<>(value));
    }

    public PureConfigUtil setInseparableLevel(int inseparableLevel) {
        configs.put("CU%inseparableLevel", new ReformPureConfig<>(inseparableLevel > - 1 ? inseparableLevel < 4 ? inseparableLevel : 3 : 0));
        return this;
    }

    public PureConfigUtil setLibraryOffset(int offset) {
        if(offset != - 1)
    ...
    public PureConfigUtil setSplitRange(int range) {
        splitRange = range;
        return this;
    }

    public PureConfigUtil setEncryptionType(EncryptionType type) {
        this.encryptionType = type;
        return this;
    }

    public PureConfigUtil setEmpty(boolean empty) {
        this.empty = empty;
        return this;
    }

    public PureConfigUtil setEntrust(String entrust) {
        addUtilConfig("entrust", entrust);
        logger = LogManager.getLogger("ConfigUtil-" + entrust);
        return this;
    }

    public PureConfigUtil setEncryptionHead(boolean encryptionHead) {
        addUtilConfig("encryptionHead", encryptionHead);
        return this;
    }

    public PureConfigUtil setAutoWrite(boolean autoWrite) {
        configs.put("CU%autoWrite", new ReformPureConfig<>(autoWrite));
        return this;
    }

    public PureConfigUtil setNote(String note) {
        addUtilConfig("note", note);
        return this;
    }

    public PureConfigUtil fuse(PureConfigUtil parent) {
        for(Object o : parent.configs.keySet())
            this.setConf(true, o.toString(), parent.configs.get(o.toString()).getValue());
        return this;
    }

    public PureConfigUtil setEncryption(boolean encryption) {
    ...
    public Map<Object, ReformPureConfig<Object>> getConfigs() {
        return configs;
    }

    public ReformPureConfig<Object> getConfig(Object conf) {
    ...
    public void setConf(boolean init, Object key, Object... configKeysValues) throws IllegalArgumentException {
        if(configKeysValues.length > 1) {
            ...
            configs.put(key, new ReformPureConfig<>(configKeysValues));
        } else {
            configs.put(key, new ReformPureConfig<>(configKeysValues[0]));
        }
    ...
    public void setListConf(boolean init, Object key, Object... configValues) {
        configs.put(key, new ReformPureConfig<>(configValues));
        if(getUtilBoolean("autoWrite") & ! init) {
            try {
                writeConfig();
            } catch (Exception e) {
    ...
    public String getConfigString(Object config) {
        ReformPureConfig<Object> c = getConfig(config);
        if(c == null)
            return null;
